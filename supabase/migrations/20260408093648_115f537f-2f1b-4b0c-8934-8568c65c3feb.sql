...
BEGIN
  ...
  IF p_category_id IS NULL THEN
    ...
    WHERE er.tenant_id = p_tenant_id
      ...
      AND (_repair_filter IS NULL OR er.is_repair = _repair_filter);
  ELSE
    SELECT
  ...
  -- 1b. Lợi nhuận kinh doanh (chỉ sold)
  SELECT
  ...
  -- 1c. Trừ lợi nhuận mất từ trả hàng
  IF p_category_id IS NULL THEN
    SELECT
  ...
  -- 6. Lợi nhuận theo danh mục (chỉ sold)
