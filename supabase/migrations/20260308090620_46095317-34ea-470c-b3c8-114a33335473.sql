...
BEGIN
  -- 1a. Tong doanh thu = tat ca don ban
  SELECT 
  ...
  -- 1b. Loi nhuan kinh doanh = tong loi nhuan tung don hang (CHI sold, KHONG tru tra hang)
  SELECT 
  ...
  -- 2. Doanh thu tra hang = tat ca don tra (chi de hien thi, KHONG tru vao loi nhuan KD)
  SELECT 
  ...
  -- Cong thuc:
  -- Doanh thu thuan = Tong doanh thu - Doanh thu tra hang
  -- Loi nhuan thuan = Loi nhuan KD + Thu nhap khac - Chi phi
...
-- Chart RPC: profit chi tinh sold, khong tru returns
