-- Drop old 2-param phone lookup that conflicts
DROP FUNCTION IF EXISTS public.lookup_warranty_by_phone(text, uuid);

-- Recreate 3-param version with ALL needed columns (staff + customer info)
...
-- Also update IMEI lookup to include customer info for rating form
