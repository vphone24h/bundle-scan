 ...
 */
export function useProductsPaginated(filters: ProductsPaginatedFilters = {}) {
  const { user } = useAuth();
...
/**
 * Lazy-load ALL variants for a single group (called when user expands a row).
 */
...
/**
 * Helper to invalidate paginated product caches after a mutation.
 */
export function useInvalidateProductsPaginated() {
