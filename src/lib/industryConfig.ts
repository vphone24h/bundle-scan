...
export const INDUSTRY_CONFIGS: Record<string, IndustryConfig> = {
  ...
  apple_landing: {
    ...
    categorySectionTitle: 'Danh mục sản phẩm',
    articleSectionTitle: 'Tin tức',
  ...
  phone_store: {
    ...
    categorySectionTitle: 'Danh mục sản phẩm',
    articleSectionTitle: 'Tin công nghệ',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  accessories_store: {
    ...
    categorySectionTitle: 'Danh mục phụ kiện',
    articleSectionTitle: 'Review & Đánh giá',
  ...
  electronics_store: {
    ...
    categorySectionTitle: 'Danh mục điện máy',
    articleSectionTitle: 'Tin tức',
  ...
  fashion_store: {
    ...
    categorySectionTitle: 'Bộ sưu tập',
    articleSectionTitle: 'Xu hướng thời trang',
  ...
  shoes_store: {
    ...
    categorySectionTitle: 'Danh mục giày dép',
    articleSectionTitle: 'Review giày',
  ...
  cosmetics_store: {
    ...
    categorySectionTitle: 'Danh mục mỹ phẩm',
    articleSectionTitle: 'Mẹo làm đẹp',
    productSectionTitle: 'Best seller',
  ...
  spa_store: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Bí quyết làm đẹp',
  ...
  salon_store: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Xu hướng tóc',
    productSectionTitle: 'Dịch vụ nổi bật',
  ...
  restaurant_store: {
    ...
    categorySectionTitle: 'Thực đơn',
    articleSectionTitle: 'Ẩm thực',
  ...
  boba_store: {
    ...
    categorySectionTitle: 'Menu đồ uống',
    articleSectionTitle: 'Tin tức',
    productSectionTitle: 'Best seller',
  ...
  realestate_store: {
    ...
    categorySectionTitle: 'Loại hình dự án',
    articleSectionTitle: 'Tin bất động sản',
  ...
  car_showroom: {
    ...
    categorySectionTitle: 'Dòng xe',
    articleSectionTitle: 'Tin tức xe',
  ...
  furniture_store: {
    ...
    categorySectionTitle: 'Danh mục nội thất',
    articleSectionTitle: 'Cảm hứng nội thất',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  construction_store: {
    ...
    categorySectionTitle: 'Danh mục vật liệu',
    articleSectionTitle: 'Tin tức',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  hotel_store: {
    ...
    categorySectionTitle: 'Chọn phòng',
    articleSectionTitle: 'Tin tức & Khám phá',
  ...
  minimart_store: {
    ...
    categorySectionTitle: 'Danh mục sản phẩm',
    articleSectionTitle: 'Khuyến mãi',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  repair_service: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Kiến thức sửa chữa',
    productSectionTitle: 'Dịch vụ nổi bật',
  ...
  training_center: {
    ...
    categorySectionTitle: 'Danh mục khóa học',
    articleSectionTitle: 'Bài viết',
  ...
  clinic_store: {
    ...
    categorySectionTitle: 'Chuyên khoa',
    articleSectionTitle: 'Kiến thức sức khỏe',
  ...
  pharmacy_store: {
    ...
    categorySectionTitle: 'Danh mục thuốc',
    articleSectionTitle: 'Sức khỏe',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  company_site: {
    ...
    categorySectionTitle: 'Lĩnh vực hoạt động',
    articleSectionTitle: 'Tin tức',
  ...
  baby_store: {
    ...
    categorySectionTitle: 'Danh mục sản phẩm',
    articleSectionTitle: 'Kinh nghiệm mẹ & bé',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  sports_store: {
    ...
    categorySectionTitle: 'Danh mục thể thao',
    articleSectionTitle: 'Review & Tin tức',
  ...
  pet_store: {
    ...
    categorySectionTitle: 'Danh mục sản phẩm',
    articleSectionTitle: 'Mẹo nuôi thú cưng',
  ...
  farm_store: {
    ...
    categorySectionTitle: 'Danh mục nông sản',
    articleSectionTitle: 'Câu chuyện nông trại',
  ...
  bakery_store: {
    ...
    categorySectionTitle: 'Danh mục bánh',
    articleSectionTitle: 'Tin tức & Công thức',
  ...
  bar_store: {
    id: 'bar_store',
    heroTitle: 'Quán nhậu chill – Mồi bén, bia lạnh',
    ...
    trustBadges: [
      ...
      { icon: 'Clock', title: 'Mở cửa 16h–24h', desc: 'Cả tuần, có nhạc sống' },
      { icon: 'CreditCard', title: 'Combo nhóm', desc: 'Tặng kèm bia & mồi' },
    ],
    categorySectionTitle: 'MENU – Mồi nhậu & Bia',
    articleSectionTitle: 'Tin quán & Sự kiện',
    productSectionTitle: 'Mồi bén – Bia ngon',
    productSectionSubtitle: 'Order ngay, bàn nào cũng có',
    emptyProductText: 'Menu đang cập nhật',
    navLabels: { home: 'Trang chủ', products: 'Menu', news: 'Tin tức', warranty: 'Liên hệ' },
    stickyBarLabels: { chat: 'Đặt bàn', call: 'Gọi ngay' },
    fontFamily: '"Playfair Display", "Georgia", serif',
  ...
  vehicle_repair: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Kiến thức xe',
  ...
  hvac_repair: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Mẹo hay điện lạnh',
  ...
  audio_store: {
    ...
    categorySectionTitle: 'Danh mục thiết bị',
    articleSectionTitle: 'Tin tức âm thanh',
    productSectionTitle: 'Sản phẩm nổi bật',
  ...
  karaoke_store: {
    ...
    categorySectionTitle: 'Chọn phòng',
    articleSectionTitle: 'Tin tức & Sự kiện',
  ...
  massage_store: {
    ...
    categorySectionTitle: 'Danh mục dịch vụ',
    articleSectionTitle: 'Sức khỏe & Thư giãn',
...
export const INDUSTRY_SUGGESTED_NAV: Record<string, NavItemConfig[]> = {
  ...
  bar_store: [
    { id: 'booking', label: 'Đặt bàn', enabled: true, type: 'page', pageView: 'booking', icon: '🍻' },
    { id: 'combo', label: 'Combo nhóm bạn', enabled: true, type: 'page', pageView: 'promotion', icon: '🎁' },
    { id: 'branches', label: 'Chi nhánh', enabled: true, type: 'page', pageView: 'branches', icon: '📍' },
    { id: 'events', label: 'Sự kiện & Nhạc sống', enabled: false, type: 'page', pageView: 'news', icon: '🎤' },
  ],
  boba_store: [
