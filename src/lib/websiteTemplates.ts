...
export const WEBSITE_TEMPLATES: WebsiteTemplate[] = [
  // Technology
  { id: 'phone_store', name: 'Cửa hàng điện thoại (banner lớn, lưới sản phẩm, giá nổi bật)', category: 'Công nghệ', description: 'Phong cách Apple Store cao cấp, tối ưu bán iPhone/Samsung', icon: '📱', tier: 'premium', available: true, defaultColor: '#0071e3' },
  { id: 'laptop_store', name: 'Cửa hàng laptop (so sánh cấu hình, lọc theo CPU/RAM)', category: 'Công nghệ', description: 'Hiện đại, chuyên nghiệp cho máy tính', icon: '💻', tier: 'premium', available: true, defaultColor: '#1e40af' },
  { id: 'accessories_store', name: 'Phụ kiện công nghệ (lưới sản phẩm nhiều màu, giá rẻ)', category: 'Công nghệ', description: 'Trẻ trung, năng động', icon: '🎧', tier: 'basic', available: true, defaultColor: '#7c3aed' },
  { id: 'electronics_store', name: 'Cửa hàng điện máy (danh mục đa ngành, khuyến mãi lớn)', category: 'Công nghệ', description: 'Chuyên nghiệp cho điện máy gia dụng', icon: '🔌', tier: 'basic', available: true, defaultColor: '#dc2626' },

  // Fashion & Beauty
  { id: 'fashion_store', name: 'Thời trang (lookbook, ảnh model lớn, lọc size/màu)', category: 'Thời trang & Làm đẹp', description: 'Phong cách Zara/Uniqlo sang trọng', icon: '👗', tier: 'premium', available: true, defaultColor: '#18181b' },
  { id: 'shoes_store', name: 'Giày dép (ảnh sản phẩm 360°, chọn size nhanh)', category: 'Thời trang & Làm đẹp', description: 'Hiện đại, tập trung hình ảnh sản phẩm', icon: '👟', tier: 'basic', available: true, defaultColor: '#ea580c' },
  { id: 'cosmetics_store', name: 'Mỹ phẩm (banner nữ tính, review sản phẩm)', category: 'Thời trang & Làm đẹp', description: 'Sang trọng, nữ tính', icon: '💄', tier: 'premium', available: true, defaultColor: '#db2777' },
  { id: 'spa_store', name: 'Spa / Thẩm mỹ viện (đặt lịch online, gói dịch vụ)', category: 'Thời trang & Làm đẹp', description: 'Thư giãn, sang trọng với đặt lịch nhanh', icon: '🧖', tier: 'premium', available: true, defaultColor: '#0d9488' },
  { id: 'salon_store', name: 'Salon tóc (gallery kiểu tóc, đặt lịch stylist)', category: 'Thời trang & Làm đẹp', description: 'Sáng tạo, hiện đại', icon: '💇', tier: 'basic', available: true, defaultColor: '#a855f7' },
  { id: 'watch_store', name: 'Đồng hồ (ảnh chi tiết, thương hiệu cao cấp)', category: 'Thời trang & Làm đẹp', description: 'Cao cấp, tinh tế', icon: '⌚', tier: 'premium', available: true, defaultColor: '#1c1917' },
  { id: 'jewelry_store', name: 'Trang sức (ảnh macro lấp lánh, bộ sưu tập)', category: 'Thời trang & Làm đẹp', description: 'Sang trọng, quý phái', icon: '💎', tier: 'pro', available: true, defaultColor: '#92400e' },

  // Food & Beverage
  { id: 'restaurant_store', name: 'Nhà hàng (menu hình ảnh lớn, đặt bàn online)', category: 'Ẩm thực', description: 'Menu đẹp, hình ảnh món ăn lớn', icon: '🍽️', tier: 'premium', available: true, defaultColor: '#991b1b' },
  { id: 'cafe_store', name: 'Quán cafe (không gian ấm cúng, menu đồ uống)', category: 'Ẩm thực', description: 'Ấm cúng, nghệ thuật', icon: '☕', tier: 'basic', available: true, defaultColor: '#78350f' },
  { id: 'boba_store', name: 'Trà sữa (menu màu sắc, topping nổi bật)', category: 'Ẩm thực', description: 'Trẻ trung, màu sắc tươi sáng', icon: '🧋', tier: 'basic', available: true, defaultColor: '#e879f9' },
  ...
  { id: 'construction_store', name: 'Vật liệu xây dựng (báo giá nhanh, danh mục VLXD)', category: 'Nhà & Xây dựng', description: 'Chuyên nghiệp, báo giá nhanh', icon: '🧱', tier: 'basic', available: true, defaultColor: '#b45309' },

  // Hospitality
  { id: 'hotel_store', name: 'Khách sạn / Homestay (đặt phòng, lịch trống, ảnh phòng)', category: 'Dịch vụ lưu trú', description: 'Sang trọng, đặt phòng trực tuyến', icon: '🏨', tier: 'pro', available: true, defaultColor: '#7c2d12' },

  // Retail
  { id: 'minimart_store', name: 'Siêu thị mini (danh mục đa dạng, tìm kiếm nhanh)', category: 'Bán lẻ', description: 'Đa dạng sản phẩm, dễ tìm', icon: '🏪', tier: 'basic', available: true, defaultColor: '#15803d' },
  { id: 'grocery_store', name: 'Cửa hàng tạp hóa (giao diện đơn giản, dễ đặt hàng)', category: 'Bán lẻ', description: 'Đơn giản, hiệu quả', icon: '🛒', tier: 'basic', available: true, defaultColor: '#0891b2' },
  { id: 'wholesale_store', name: 'Bán sỉ – đại lý (bảng giá sỉ, đặt số lượng lớn)', category: 'Bán lẻ', description: 'Bảng giá sỉ, đặt hàng nhanh', icon: '📦', tier: 'basic', available: true, defaultColor: '#2563eb' },
  { id: 'general_store', name: 'Bán hàng online tổng hợp (đa ngành, marketplace mini)', category: 'Bán lẻ', description: 'Đa ngành, marketplace mini', icon: '🛍️', tier: 'basic', available: true, defaultColor: '#e11d48' },
...
/** 50 preset brand colors organized by hue groups */
export const BRAND_COLOR_PRESETS = [
  ...
  // Oranges
  '#f97316', '#ea580c', '#c2410c', '#b45309', '#92400e',
  // Yellows / Amber
  '#f59e0b', '#d97706', '#ca8a04', '#eab308', '#fbbf24',
  // Greens
  '#22c55e', '#16a34a', '#15803d', '#059669', '#65a30d',
  // Teals / Cyan
  '#14b8a6', '#0d9488', '#0f766e', '#0891b2', '#0284c7',
  // Blues
  '#3b82f6', '#2563eb', '#1e40af', '#1d4ed8', '#0071e3',
  // Deep Blues / Navy
  '#1e3a5f', '#1e293b', '#0f172a', '#172554', '#0c4a6e',
  // Purples / Indigos
  '#7c3aed', '#6d28d9', '#6366f1', '#4f46e5', '#a855f7',
  // Dark / Neutral
  '#9333ea', '#78350f', '#57534e', '#18181b', '#000000',
];
