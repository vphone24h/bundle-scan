...
export function downloadImportTemplate() {
  ...
  // Define headers matching user's exact template format
  const headers = [
    'IMEI',
    'Tên sản phẩm',
    'SKU',
  ...
  const instructionsData = [
    ...
    [''],
    ['1. IMEI: Chỉ nhập cho sản phẩm có số IMEI (điện thoại, máy tính bảng...). Nếu có IMEI, số lượng tự động = 1'],
    ...
    ['- Thư mục, Nhà cung cấp, Chi nhánh phải được tạo trước trong hệ thống'],
  ];
