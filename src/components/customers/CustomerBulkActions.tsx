...
export function CustomerBulkActions({ selectedIds, onClearSelection }: CustomerBulkActionsProps) {
  ...
  return (
    <>
      <div className="flex items-center gap-2 p-2 px-3 bg-primary/5 border border-primary/20 rounded-lg flex-wrap">
        ...
        <Popover open={tagOpen} onOpenChange={setTagOpen}>
          ...
          <PopoverContent className="w-56 p-2" align="start">
            ...
            <div className="space-y-1 max-h-[200px] overflow-y-auto">
              ...
              {(!tags || tags.length === 0) && (
                <p className="text-xs text-muted-foreground p-2">Chưa có tag. Vào Quản lý Tag để tạo.</p>
              )}
            </div>
          </PopoverContent>
        </Popover>
