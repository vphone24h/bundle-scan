                          ...
                          {productsData.categories.map((cat, idx) => (
                            <ScrollReveal key={cat.id} animation="fade-up" delay={idx * 80}>
                              <button
                                ...
                                className={`group w-full overflow-hidden relative text-left ${cat.image_url ? 'min-h-[220px] sm:min-h-[360px]' : 'min-h-[120px]'}`}
                              >
                                {cat.image_url ? (
                                  <>
                                    ...
                                    <div className="relative z-10 h-full flex flex-col justify-end p-6 min-h-[220px] sm:min-h-[360px]">
