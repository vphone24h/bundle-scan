          ...
          <div className="max-w-[1024px] mx-auto px-4 py-8">
            ...
            {categories.length > 0 && (
              <SwipeGuardScroll className="flex gap-2 overflow-x-auto pb-4 scrollbar-hide">
                ...
                {categories.filter((c: any) => !c.hidden_from_products_page).map(c => (
                      ...
                      case 'categoryFilter':
                        return (
                          <SwipeGuardScroll key="categoryFilter" className="mb-6 flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                            ...
                            {(articlesData?.categories || []).filter((c: any) => c.is_visible !== false && !c.hidden_from_articles_page).map((cat: any) => (
