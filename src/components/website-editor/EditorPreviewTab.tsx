...
import { getIndustryConfig, getFullNavItems, LayoutStyle, HomeSection, SYSTEM_PAGES, getFooterWhyChooseTitle } from '@/lib/industryConfig';
                ...
                {ppCatMode === 'vertical' ? (
                  <section className="py-4 bg-[#f5f5f7] px-4">
                    <div className="grid grid-cols-2 gap-3">
                      {['iPhone', 'Samsung', 'Phụ kiện', 'Tablet'].map((cat, i) => (
